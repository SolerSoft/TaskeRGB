...
import com.solersoft.taskergb.tasker.getartists.MusicArtist
import com.solersoft.taskergb.tasker.getartists.MusicSong
import com.solersoft.taskergb.tasker.getip.GetIPInput
import com.solersoft.taskergb.tasker.getip.GetIPInputOptions
import com.solersoft.taskergb.tasker.getip.GetIPOutput
...
class TestProguard {
    ...
    fun neededClasses() {
        ...
        //class names
        assertEquals("com.solersoft.taskergb.TestInput", inputClass.name)
        assertEquals("com.solersoft.taskergb.TestOutput", outputClass.name)
        assertEquals("com.solersoft.taskergb.ActivityConfigTest", activityClass.name)
        assertEquals("com.solersoft.taskergb.TestRunner", runnerClass.name)
