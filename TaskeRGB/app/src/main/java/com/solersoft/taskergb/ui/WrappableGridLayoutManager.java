...
public class WrappableGridLayoutManager extends GridLayoutManager {
    ...
    public WrappableGridLayoutManager(Context context) {
        super(context, 5);
    }
    ...
    public WrappableGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
